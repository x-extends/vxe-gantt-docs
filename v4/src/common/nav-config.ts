...
export const navConfigList: NavVO[] = [
  {
    ...
    children: [
      ...
      { i18nKey: 'plugins.base.nav.demoSubview', isEnterprise: true, routerLink: { name: 'EnterprisePreview', params: { previewCode: 'extend_gantt_chart_demo_subview' }, query: { previewPath: '%2FextendGanttChart%2Fdemo%2Fsubview' } } },
